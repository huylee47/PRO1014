                ...
                <div class="row fill_height">
                    ...
                    <div class="col-lg-5 offset-lg-4 fill_height">
                        <div class="banner_content">
                            <h1 class="banner_text">Sản phẩm mới ra mắt</h1>
                            <div class="banner_price"><span>$1030</span>$1000</div>
                            <div class="banner_product_name">Iphone 15 pro max</div>
                            <div class="button banner_button"><a href="index.php?act=cuahang">Mua ngay</a></div>
                        </div>
                    </div>
                </div>
            </div>
